"""
Train Momentum Model - M15 V3 (less sensitive velocity exit 0.02)
=================================================================
"""
import warnings
...
log("=" * 70)
log("TRAINING MOMENTUM MODEL - M15 V3 (exit 0.02)")
log("=" * 70)
...
joblib.dump(model, MODEL_DIR / 'momentum_xgb_m15_v3.joblib')
with open(MODEL_DIR / 'momentum_xgb_features_m15_v3.pkl', 'wb') as f:
