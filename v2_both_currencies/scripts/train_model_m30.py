"""
Train PnL-Based XGBoost Model - V2 Both Currencies (M30)
=========================================================
...
log("=" * 70)
log("TRAINING PNL-BASED MODEL - V2 BOTH CURRENCIES (M30)")
log("=" * 70)
...
# Load data
log("\nLoading V2 quality entry data (M30)...")
with open(DATA_DIR / 'quality_entry_data_m30_v2.pkl', 'rb') as f:
    data = pickle.load(f)
...
# Features - M30 version (vel2 and acc on M30)
feature_cols = [
    ...
    'base_vel2_m30', 'base_acc_m30',
    'quote_vel2_m30', 'quote_acc_m30',
...
# Save model
model_path = MODEL_DIR / 'quality_xgb_m30_v2_pnl.joblib'
features_path = MODEL_DIR / 'quality_xgb_features_m30_v2_pnl.pkl'
