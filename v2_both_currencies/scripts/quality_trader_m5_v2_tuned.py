"""
Quality Entry Trader V2 - Tuned Model (M5)
==========================================
Uses the hyperparameter-tuned model from grid search.
Parameters optimized via 3-fold time-series cross-validation.

Best params: max_depth=4, learning_rate=0.05, min_child_weight=10,
             subsample=0.9, colsample_bytree=0.8, gamma=0.2

Holdout performance (Sep-Dec 2025, with spread):
  @ 0.75: 82.7% WR, PF=8.79, +9.0 pips/trade
...
# Trading Parameters
LOT_SIZE = 0.01
MAGIC_NUMBER = 150054  # V2 Tuned model magic number
MAX_SPREAD_PIPS = 5
MAX_POSITIONS = 100
...
class TradeLogger:
    ...
    def __init__(self, log_dir: Path):
        ...
        self.trades_file = self.log_dir / "trades_v2tuned.csv"
        self._init_file()
...
# ============================================================================
# QUALITY MODEL MANAGER (Tuned Model)
# ============================================================================
...
class QualityModelManager:
    ...
    def load(self) -> bool:
        model_path = self.model_dir / 'quality_xgb_m5_v2_tuned.joblib'
        features_path = self.model_dir / 'quality_xgb_features_m5_v2_tuned.pkl'
...
class QualityEntryStrategyV2Tuned:
    ...
    def initialize(self) -> bool:
        log.info("=" * 60)
        log.info("QUALITY ENTRY TRADER V2 - TUNED MODEL (M5)")
        log.info("=" * 60)
