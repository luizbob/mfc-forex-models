...
log("=" * 70)
log("TRAINING MOMENTUM MODEL (M30)")
log("=" * 70)
...
# Load data
log("\nLoading data...")
with open(DATA_DIR / 'momentum_entry_data_m30.pkl', 'rb') as f:
    data = pickle.load(f)
...
# Feature columns - M30 base timeframe
feature_cols = [
    ...
    # Additional momentum features (M30)
    'base_vel3_m30', 'base_vel5_m30',
    'quote_vel3_m30', 'quote_vel5_m30',
    'base_acc_m30', 'quote_acc_m30',
    # Divergence
