...
log("=" * 70)
log("TRAINING MOMENTUM MODEL (M5)")
log("=" * 70)
...
feature_cols = [
    ...
    'base_vel3_m5', 'base_vel5_m5',
    'quote_vel3_m5', 'quote_vel5_m5',
    'base_acc_m5', 'quote_acc_m5',
    # Divergence
...
# Save model
model_path = MODEL_DIR / 'momentum_xgb_m5.joblib'
joblib.dump(model, model_path)
log(f"\nModel saved to: {model_path}")

# Save features
features_path = MODEL_DIR / 'momentum_xgb_features_m5.pkl'
