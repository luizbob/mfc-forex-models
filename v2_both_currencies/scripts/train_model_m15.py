"""
Train PnL-Based XGBoost Model - V2 Both Currencies (M15)
=========================================================
...
log("=" * 70)
log("TRAINING PNL-BASED MODEL - V2 BOTH CURRENCIES (M15)")
log("=" * 70)
...
# Features - now includes quote momentum features
feature_cols = [
...
# Save model
model_path = MODEL_DIR / 'quality_xgb_m15_v2_pnl.joblib'
features_path = MODEL_DIR / 'quality_xgb_features_m15_v2_pnl.pkl'
