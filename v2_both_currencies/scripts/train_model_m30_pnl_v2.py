"""
Train PnL Model M30 V2 - Fixed Version
======================================
Saves to NEW files: quality_xgb_m30_v2_pnl_fixed.joblib
...
log("=" * 70)
log("TRAINING PNL MODEL M30 V2 - FIXED")
log("=" * 70)
...
# Save NEW model
model_path = MODEL_DIR / 'quality_xgb_m30_v2_pnl_fixed.joblib'
features_path = MODEL_DIR / 'quality_xgb_features_m30_v2_pnl_fixed.pkl'
